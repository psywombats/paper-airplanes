label c05_intro:
    ...
    [NVL formant]
    The same darkness engulfs me inside of the hospital room, blocking the bright spring sunlight.
    ...
    I looked down at my lap, where the sketchbook and pencil the girl had given me yesterday sat.
    ...
    I could never admit this to someone... [Pause] But I was rather glad to receive the sketchbook.
    I love writing... [Pause] I wasn't using such empty words that most people used when speaking.
    ...
    My relaxed body suddenly tensed as I glared at the door, turning my attention back to the curtains.
    ...
    Something was suddenly placed on my lap, causing me to flinch and turn my attention towards the nurse.
    nurse "Sheesh, so jumpy! [Pause] At least your reflexes are good."
    I glanced over to my lap, a tray of food catching my attention which caused me to relax slightly.
    ...
    ... [Pause] The first step of recovering...
    Slowly, I grabbed a spoon and began to eat the rice with the eggs.
    [Transition]
    It was eleven thirty in the morning, the darkness still covering my room.
    ...
    With no light to draw or write, I laid on the bed while staring out of the door's window. Waiting patiently for Celia to arrive.
    ...
    As I continued to star out of the door's window, a strange creature suddenly popped up from the other side.
    k "?!"
    Startled, I sat up quickly, causing my left shoulder to throb. 
    I gripped my shoulder in pain, pressing my lips together to hold in a scream of pain that I knew would never come anyway.
    Strange Creature "Nyu!"
    k "?!?!"
    Without me even noticing the door opening, the strange creature flew towards me and stared at me.
    k "..."
    Strange Creature "Nyu... Nyu?"
    k "..."
    ...
    I stared at the strange creature, my reflection being reflected from its eyes.
    ... [Pause] It's cute.
    ...
    menu:
        "Be honest":
            ...
            k ""Thanks.""
            Celia smiled, her expression practically lightened up the room.
    ...
    ... [Pause] Cute.
    Looking down at the sketchbook, I carefully ripped a single sheet of paper along with the holed-rom, making the paper clean.
    c "Th-Thank you!"
    ...
    So why?
    I'm dead anyways... [Pause] Why did she agree to this "hospital buddies" situation?
    ...
    [Transition]
    c "And... [Pause] Done!"
    I raised my eyebrows in slight surprise and amusement, and I feel little excited to see the ten minute creation.
    ...
    Celia giggled as my blush continued to reddened. Even when I try to bring myself together, nothing seems to work.
    c "Well, in that case... [Pause] let's decorate your entire room with lobtus flowers!"
    k "?!"
    Celia smiled brightly turning around and practically began to run towards the door.
    c "I have some colored pencils in my room! [Pause] I'll get some as well as some paper!"
    I stared at the open door, where I saw several nurses from the nurses' station stare at the direction Celia went.
    ...
    Shortly after getting a ridiculous amount of paper as well as a box of colored pencil, Celia taught me how to make the paper lobtus flowers.
    ... [Pause] Finished.
    ...
    I showed her the lobtus flower, in which she sniffs as her ears twitch.
    n "Nyu nyu!"
    k "..."
    ...
    It certainly compliments her smiley personality.
    n "Nyu..."
    Sighing, Nyu's ears enlarge which caused me to blink in surprise.
    ...
    It's hard to forget about your family... [Pause] Even when there's no more.
    ...
    if $c03_kenta_interesting:
        The man's eyes widened slightly at the sight of my missing arm, blinking frequently to adjust to the dark room.
        My eyes are up here, asshole.
        As if he had hear me, his eyes went straight up and looked for my eyes.
        ...
        The man named "Toma" looked at Celia and I, his face straight and hard to read.
        ...
        They weren't.
        I looked up at the man, who was laughing and shot him a glare.
        man "Ahaha, you're face is pretty red! [Pause] Can't believe you fell for it."
        ...
        Soon, the three of them were gone. [Pause] I was alone in the usual darkness with paper lobtus flowers.
        k "..." 
    ...
    if $c03_kenta_strange:
        ...
        man "..."
        k "..."
        The silence was rather tense, as if the air was filled with toxic gasses and just a single whiff would arise a fight.
        ...
        Her ears enlarge like earlier before she swooped down, landing next to the sleeping Celia.
        man "...Hm?"
        The stranger attention turned towards Nyu, his eyes widening at the sight of Celia.
        His face darkened once again as he swiftly headed towards Celia, Nyu, and I.
        My body tense as he stopped behind Celia, his eyes focused on her sleeping figure.
        ...
        I ignored the stranger and continued to stare at the windows as I felt Celia's weight that had slightly held down the side of the bed down, slowly lift off balancing the bed.
    ...
    With a silent grunt, I move the paper flowers to the right side of the bed, tucked myself underneath the cloth and laid down.
    With the annoying beeping of the strange machine, my eyes flutter close, taking me to a dream world.
    [End Chapter 5]
