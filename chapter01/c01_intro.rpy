label start:
    ...
    As confused as the daughter was, she had a feeling that... [Pause] she would't be able to see her mother ever again if she goes.
    ...
    How long have I awoken to that same dream? [Pause] Possibly for three or four years now...
    ...
    n "Nyu!"
    Nyu triumphantly placed her paws where her hips would be, her ears twitching happily.
    I giggled at Nyu's response, gently petting her head.
    Suddenly, my stomach growled at me, demanding food.
    ...
    m "Sounds like a victim from an accident... [Pause] But your room is almost soundproof, so the fact that we can hear them is..."
