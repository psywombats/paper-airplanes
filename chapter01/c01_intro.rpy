label start:
    ...
    "Our curse."
    The mother muttered under her breath, barely coming out as a whisper.
    She suddenly stood up, causing her daughter to tilt her head to the side.
    "Hm? [Pause] Are you going somewhere, Mama?"
    ...
    "Mama, wait! [Pause] Please wait for me! I-I can't move!"
    The daughter cried out, confusion and fear stirring up inside her.
    Before her, her mother was slowly going away.
    As confused as the daughter was, she had a feeling that... [Pause] she won't be able to see her mother ever again if she goes.
    ...
    ??? "Mama!"
    {Celia is lying in bed, her arm stretched out, intense and sweaty}
    ??? "Ah...!"
    ??? "...That dream again..."
    ...
    Needing to calm myself, I listened to the soft ticking of the clock that hung near the door and the gentle beeping of the heart monitor.
    How many times have I awoken to that same dream? [Pause] Possibly for three or four years now...
    ...
    Although, I know why she left in real life... [Pause] It is the same reason why I live in a hospital.
    ...
    My eyelids felt heavy and my arms didn't have much feeling in them, but I somehow manage.
    Once I was propped up with my torso limply slouching over my legs, I glanced over to the clock. [Pause] It's seven in the morning.
    I woke up right on time as always. [Pause] Maybe I really do have an alarm clock embedded in my body that wakes me up.
    I arch my back a little, feeling the tension in my body disappear and began to rub my eyes, yawning in the process.
    I look over to the right, where the only true window in my room hid behind the thick white curtains.
    ...
    Let's see... My room would probably look nice if it was colored... [Pause] Green.
    ...
    And that wouldn't be very good. [Pause] That would be horrible.
    [ADV Format]
    ??? "Nyu!"
    Suddenly, a high pitched voice squeaks to my left, snapping me back to reality.
    I look over to the left and see my friend and pet, Nyu, land on my bed.
    Using her small and stubby little arms and legs, she manages to wobble over my direction, her small glossy black eyes shining in excitement, and her cute little button nose twitching.
    I smile at Nyu when she stops right next to me, a slight look of exhaustion on her face.
    ...
    After a moment of silence and rummaging, Nyu pulls out a small note card and practically thrusted it at me.
    I hesitantly take the card from Nyu's paws, smiling nervously at Nyu's forward behavior.
    Looking down at the card, I noticed that it appears to be blank.
    I glance over to Nyu, not knowing why she had given this to me.
    n "Nyu!"
    Nyu pointed at the card with confidence, huffing excitedly.
    I glance back to the card, wondering what secrets it had.
    I began to twirl the card around, eyeing each corner of it for clues when I notice three letters on the back.
    ??? "'H.B.C'...?"
    I tilt my head in confusion at the three mysterious letters.
    I had a feeling that they meant something, but since I was still groggy from my sleep, I couldn't interpret the meaning.
    ...
    After a moment, I gasp softly in realization. 
    Today is my fourteenth birthday.
    On instinct at the realization, my shoulders slump, as if trying to dampen the mood.
    ...
    A majority of my friends mainly remember today as mother's death...
    ...
    The "H.B.C" must stand for "Happy Birthday Celia." [Pause] They are the three letters that Nyu could manage to write.
    I look over to Nyu and smile.
    c "Thank you for the present, Nyu! [Pause] Your handwriting has really improved!"
    n "Nyu!"
    Nyu triumphantly places her paws on where her hips would be, her ears twitching happily.
    I giggle at Nyu's response, gently petting her head.
    Suddenly, my stomach growled at me; demanding for food.
    Nyu squeaked in surprise from the sudden growl, jerking backwards.
    I giggle at Nyu's tumble from my stomach and look over to the clock again. 
    It's 7:25.
    c "Oh dear, it's almost 7:30 already? [Pause] She's running a little late, isn't she?"
    I hear Nyu squeak in reply, agreeing with me.
    ...
    I raise an eyebrow at Meadow's greeting, surprise at what she has called me.
    That was the first time she had called me "Miss Celia".
    c "Good morning, Miss Meadow!"
    Meadow blinks several times in surprise as she stops beside the bed, a surprised look on her face.
    ...
    c "Well, you called me "Miss Celia". [Pause] I'm assuming that this is a new name game?"
    ...
    After laughing, I began to eat my food as Meadow took the clipboard from the end of my bed and wrote down the heart monitor's complicated numbers.
    ...
    It's a strange rule for some- especially me, since I love milk.
    Suddenly, I hear a loud and stress disarray of voices coming from the other side of the door.
    Surprised by the sound of the voices, I slowly stop eating as Meadow turns her attention towards the door.
    c "Huh? [Pause] What's going on out there?"
    m "Sounds like a victim from an accident... [Pause] But your room is almost sound proof, so the fact that we can hear it is..."
    ...
    I blink in surprise at Meadow's order, rather confused by her words.
    Stay in my room...?
