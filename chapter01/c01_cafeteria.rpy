label c01_cafeteria:
    ...
    Many people disliked sitting at this area due to the lack of light. [Pause] However, I found it to be more reason to sit there.
    Perhaps it was just me, but I had always enjoyed sitting in a low light area. [Pause] The strong heat coming off of the lightbulbs and the bright light shining had always bothered me.
    ...
    if $white_book == 1:
        ...
        The curse that had fallen upon my mother and I... [Pause] were different and yet so similar.
    ...
    t "Aw, come on! [Pause] The kids outside are making more noise than I am!"
    ...
    t "Aw man, it's that time already? [Pause] I didn't even notice how late it was!"
    ...
    Toma often used those hours to sleep and occasionally to stop by to see me like today. [Pause] But that was only when he had the treat of obtaining his pay.
