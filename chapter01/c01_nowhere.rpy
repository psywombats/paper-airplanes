label c01_nowhere:
    ...
    I giggled a little as I throw my up into the air.
    ...
    t "Hahaha!"
    t "You got that right. [Pause] It's boring working hour after hour with no one to talk to, except for a strict man on occasions.
    I giggled at Toma's words, and the two of us began to walk.
    With no specific location, we were able to go freely as we please. [Pause] Nothing chaining us down.
    ...
    ??? "Out of the way, kids!"
    Interrupting Toma, a loud raspy voice cried out to us as the sound of wheels gradually gotten louder.
    I looked forward, where a couple of elderly men and women began to rush towards us in wheelchairs, their faces plastered in concentration.
    ...
    t "Hey! [Pause] I thought the nurses told you all not to do anymore wheelchair races!"
    Elderly A "Wahahaha! [Pause] You youngsters think you can order us around?! My, has the youth fallen."
    ...
    Elderly A "Quite the sassy little thing as always, eh Toma?"
    t "Heh, you better believe it old man."
    Elderly B "So rude to your elders! [Pause] We know that you are trying to impress your little girlfriend by acting tough, but please do so with a little more manors!"
    ...
    Elderly A "Well, how about another round gang?"
    ...
    The third floor was used as some sort of relaxation center, where a majority of hospital residents and their visitors hanged out in.
    ...
    Despite the little girl's mother wearing a hospital gown, the family looked so happy together.
    ...
    The nurses fell silent, their once smiling faces transforming into ones that showed uncomfort.
