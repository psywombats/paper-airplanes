label c01_library:
    ...
    t "Hahaha, come on, don't be that way! [Pause] I'm only teasing you!"
    ...
    t "This place has a surprisingly low number of books in regards to legends. [Pause] You would think that the library would import new ancient books that are actually important instead of those boring and inappropriate romance novels."
    ...
    c "Although... I'm not sure that her romance novels are inappropriate."
    t "Ha... Haha... [Pause] That's what you think..."
    ...
    c "Oh my, I'm sorry Toma! [Pause] Were you saying something?"
    ...
    ??? "RAWR!"
    c "Eek!"
    I jumped in my seat, the books I was holding onto so tightly flying in the air.
    Laughter filled the library as I panted, calming my racing heart.
    t "Oh good Ion, that was... Hahaha!"
    c "T-Toma...!"
    t "Hahaha...! [Pause] I'm sorry, I... I couldn't help it!"
    ...
    t "... [Pause] It doesn't fit you, really."
    ...
    c "Hehe, that's true. [Pause] Thank you for everything, including being my friend."
    t "What? [Pause] I'm not your best friend yet?"
    c "Hehe, I think Ivy is still my best friend."
    t "Oh, ouch! [Pause] Your words stab me!"
    The two of us began to laugh, my soft giggling drowning in Toma's gentle chuckles.
    I always felt at peace when I was with Toma. [Pause] He seemed to have always find the right way to cheer me up, even when nothing was bothering me at all.
