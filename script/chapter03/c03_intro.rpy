label c03_intro:
    ...
    What I had originally planned to be a nap turned out to be a slumber that lasted the entire night.
    ...
    I looked over to the window, my eyelids closing halfway.
    Ah, it looks like it will be a nice day again. [Pause] Lots of sunshine.
    Nyu wobbled over to me and lay down on my lap, yawning softly in exhaustion. 
    ...
    [Transition]
    It was 7:20 when Meadow entered my room with bright eyes and a happy smile, a tray of food in hand as usual.
    ...
    Meadow's voice had woken up Nyu, causing her to roll off my lap and lazily slide underneath the blanket as Meadow walked towards me.
    ...
    m "Thankfully, no."
    Meadow placed the tray down on top of my lap. Like she had said, the omelet that would usually take up most of the plate barely covered the middle of the plate.
    I picked up my fork and gently cut the middle of the omelet.
    While usually what would spill would be white steaming strands of rice with a thin layer of egg, this time it was only a small ounce of rice with a rather thick layer of eggs.
    ...
    m "Anyway, as you're the only one I'd been assigned to help... [Pause] I have also been assigned to take care of him."
    m "But he's a rather stubborn and rude boy! [Pause] I'd prefer to take care of you rather than him."
    ...
    c "Ah, well maybe he just needs to feel more welcome in the hospital!" 
    ...
    al "Yes, it is."
    Meadow laughed nervously at my tutor's straight face and stood up, giving Alalia the spot where Meadow had been sitting.
    ...
    c "Ehehe... Well, Nyu is my emergency caretaker."
    c "Besides Meadow, Nyu must be by my side at all times in case something happens. [Pause] So, yes. She does."
    a "I know far too well about the creature's importance to your health." 
    ...
    [Transition]
    About an hour or so had passed. [Pause] Alalia was tutoring me as ruthlessly as ever.
    ...
    c "Huh? [Pause] Again?"
    a "Quite the racket they're making..."
