label c03_study:
    ...
    As much as I want to see what the boy is doing... [Pause] I can't stop in the middle of the lesson.
    Alalia is a very strict teacher, and she would be upset if I stopped now all of a sudden.
    With one last glance at the door, I returned to my work and continued to finish the math problem.
    [Transition]
    ...
    Lunch time had arrived, and with Alalia gone, it left Nyu and I to entertain ourselves while waiting for our meals.
    ...
    The tray has consisted of a bowl filled with thick noodles and pieces of chicken sitting in a steamy broth, a small plate of greens such as lettuce, a piece of dried beef, and a small of lukewarm water.
    ...
    m "Hm?"
    Meadow, who had already began to write down the heart monitors complicated number turned to my direction as I pulled out the piece of paper with Nyu's drawing on it.
    ...
    I smiled nervously at Meadows response, placing my fork that was used to eat the crisp greens down.
    ...
    m "It would make more sense if he becomes very attached to someone. [Pause] That would be a sign of post traumatic disorder."
    c "That's true..."
    ...
    Meadow didn't say a word after that, turning her attention towards the clipboard that she had yet to finish writing the complicated numbers of the heart monitor.
    I had become too nervous to say anything, the atmosphere eating my words every time I opened my mouth and tried to say something.
    Even Nyu had began to become uncomfortable by the atmosphere, staring at me as she slowly chewed on her almost gone beef.
    For some reason... [Pause] Meadow looked sad as she scribbled down the monitors numbers.
    ...
    He was clearly causing trouble for Meadow, and seems that he wants to escape from here.
    ...
    I placed my hands next to each other as a landing platform for Nyu, to which she gently placed the vial on.
    ...
    Peeking out of the doors window, I saw that the den which was known as the nurses station was empty. [Pause] No wolves known as nurses in sight.
    It was around one thirty, so it was lunch break for all the nurses in the west wing.
    It was the perfect opportunity to go and welcome the boy with no problems.
    Gripping onto the vial, I opened the door and stepped outside of my room,the door gently closing behind me.
    ...
    Room 294... [Pause] Although I had never seen the number plate of the boy's residing room, I knew that it had to be this one.
    Room 294 hasn't seen a new patient for two years, after the previous resident had died of heart failure.
    Swallowing the saliva that had formed in my mouth from nervousness, I peeked inside the room through the small door.
    ...
    Shaking my curious thoughts about the lights, I stood up straight and gently knocked on the door.
    Counting to ten, I sighed reassuringly and slowly opened the door.
    Taking a step inside of the room, I noticed how much darker the room was than it look, the only source of light coming from the slightly open door that only reached the edge of the bed.
    With the limited light, I squinted in the dark, making out the figures when my eyes met a pair of dangerous green ones.
    Boy "..."
    c "Ah!"
    ...
    Boy "..."
    The boy snorted softly as his eyes softened, turning his head towards the curtained window next to him.
    I fell silent at his actions, looking down at my feet as I thought about what to say.
    To him, I'm just a stranger who had just rudely entered his room without permission.
    ...
    I fell silent by this, curious as to why he didn't open them.
    ...
    The food on the plate consisted of a small portion of rice that had grown cold when you inch your hand near it, a bowl of vegetables and meat, and a cup of warm water that sat in front of three small pills.
    The food looked as if it was just delivered to him, but the cold air that drifted off form it told a different story.
    ...
    The boy turned his direction towards me, eyes wide at my announcement.
